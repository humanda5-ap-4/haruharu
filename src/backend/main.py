...
import DB.crud
from DB.services import intent_map, generate_answer,handle_stock,handle_game,handle_festival,handle_l2m
...
async def chat(
    ...
    result = handler(db, ents) if handler else None
    answer = generate_answer(intent, result)
